...
public class Monitoring {
    ...
    public static void main(String[] args) throws IOException, InterruptedException
    {
        ...
        while(true)
        {
            ...
            while((line=in.readLine())!=null)
            {
                ...
                Double restCpu = availableCore - print(datas);
    ...
    // 컨테이너에 대한 정보 확인
    public static double print(List<Map<String,Object>> datas) throws IOException
    {
        ...
        for(Map<String,Object> data : datas) // 컨테이너 개수만큼 반복문 실행
        {
            ...
            */
            ...
            else
            {
                ...
                packet_arr[i] = new RxTx(rxb0,rxp0,txb0,txp0);
                System.out.println(new RxTx(rxb1,rxp1,txb1,txp1).toString());
            }
