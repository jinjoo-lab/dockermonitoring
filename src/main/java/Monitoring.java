...
public class Monitoring {
    ...
    {
        // mac 형식의 파일 경로입니다. 사용자의 컴퓨터에 따라 변경하여 사용
        String path = "/Users/jinjuwon/Documents/mac_git/demo/dockerhw/src/main/java/result2.txt";
        ...
        while(true)
        {
            ...
            while((line=in.readLine())!=null)
            {
                ...
                // host 유휴 메모리 확인 JVM내의 메모리가 아닌 OS 메모리
    ...
    public static double print(List<Map<String,Object>> datas,JSONObject json) throws IOException, InterruptedException
    {
        ...
        for(Map<String,Object> data : datas) // 컨테이너 개수만큼 반복문 실행
        {
            ...
            object.put("IP Address",IpAddress.get("IPAddress"));
            System.out.println("Process Id : "+data.get("Id")); // 컨테이너의 ID 확인
            object.put("Process ID",data.get("Id"));
            ...
            object.put("container name",obj.substring(1,obj.length()));
            ...
            object.put("CPU num",cpu_stats.get("online_cpus"));
            ...
            object.put("container memory",Climit);
            ...
            object.put("CPU percent",percent);
            ...
            object.put("memory usage",used_memory);
            ...
            object.put("memory percent",m_percent);
            ...
            int rxb0 = Integer.parseInt(eth0.get("rx_bytes").toString());
            int rxp0 = Integer.parseInt(eth0.get("rx_packets").toString());
            int txb0 = Integer.parseInt(eth0.get("tx_bytes").toString());
            int txp0 = Integer.parseInt(eth0.get("tx_packets").toString());
            ...
            if(packet_arr[i]==null)
            {
                ...
                object.put("network",packet_arr[i].toString());
            }
            else
            {
                ...
                object.put("network",packet_result);
            }
            json.put(i,object.toJSONString()) ;
            i++;
        }
        return CpuUse;
    }
